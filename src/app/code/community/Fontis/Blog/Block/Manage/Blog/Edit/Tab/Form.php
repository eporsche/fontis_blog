...
class Fontis_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('blog_form', ['legend' => $blogHelper->__('Post Information')]);
        ...
        $fieldset->addField('cats', 'multiselect', [
            'name'     => 'cats[]',
        ...
        $fieldset->addField('comments', 'select', [
        ...
        $fieldset->addField('summary_content', 'editor', [
    ...
    {
        return in_array($state, [Mage_Cms_Model_Wysiwyg_Config::WYSIWYG_ENABLED,
            Mage_Cms_Model_Wysiwyg_Config::WYSIWYG_HIDDEN
        ]);
    }
