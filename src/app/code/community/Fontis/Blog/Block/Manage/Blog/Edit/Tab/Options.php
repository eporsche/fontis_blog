...
class Fontis_Blog_Block_Manage_Blog_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('blog_form', ['legend' => $blogHelper->__('Meta Data')]);

        $fieldset->addField('meta_keywords', 'editor', [
            'name'  => 'meta_keywords',
        ...
        $fieldset->addField('meta_description', 'editor', [
        ...
        $fieldset = $form->addFieldset('blog_options', ['legend' => $blogHelper->__('Advanced Post Options')]);

        $fieldset->addField('user', 'text', [
        ...
        $fieldset->addField('created_time', 'text', [
